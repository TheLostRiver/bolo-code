...
```bash
npm run build          # → dist/bolo.mjs (1,691,077 bytes, 195 模块)
```
...
| 指标 | 实测 | 预算（超出即需解释） |
|---|---|---|
| CLI 产物体积 | 1,691,077 bytes / 195 模块（OI-14H；较 1,385,065B 基线 +306,012B） | 基线 +1,500,000 bytes |
