...
| **CLI TUI 的真实 Windows Terminal 呈现** | ❌ 未验证 | OI-09 已覆盖 input reducer/raw driver、CJK/emoji cell 宽度、ANSI、首 token gate、宽窄快照与完整门禁；但真实字体下的光标、重绘、resize、Ctrl+J/历史/删除组合键和长回答滚动仍需真人走查 |
