...
**当前主线：** **Durable Turn DR2C**（§13：control/recovery durable projection；DR0–DR2B3 已完成）。
...
| **DR2** | `SessionCoordinator`：同 session 单 runner、跨 session 并行、safe-boundary `queue/steer/interrupt` | DR2A–DR2B3 ✅ · DR2C 📋 |
