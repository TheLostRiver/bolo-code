...
| **CLI TUI** | **~85–92%** | OI-14 retained renderer 主体与 OI-15A–F command surface/lifecycle 已完成；只读状态使用有界 panel/text pager，扩展目录与动作选择使用稳定 overlay，短反馈使用 footer toast；OI-H3 真人 Windows Terminal 仍未验 |
