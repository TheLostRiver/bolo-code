...
> **状态：** ✅ **CX1–CX6 主路径已实现**（preset · resume providerId · errors · **model caps** · 热切 tip · `/model` 建议）；CX7 Desktop 待续；CX8 后置  
...
> **测试：** `scripts/test-provider-ux.ts` · `test-effort-dialect` · `test-multi-provider`
