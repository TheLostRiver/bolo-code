...
| **CLI TUI** | **~89–95%** | OI-14 retained 主体、OI-15A–F slash lifecycle、OI-16/17 pager 布局与 OUT-1..3 ToolPresentation、默认折叠、键盘预览、按需全文与恢复已完成；OUT-4/5 鼠标与聚合待实现 |
...
已交付但没有正式 session delete consumer；鼠标和只读调用聚合分属 OUT-4/5。正式契约见
[TOOL_OUTPUT_AND_MODEL_CONTEXT_DESIGN.md](./TOOL_OUTPUT_AND_MODEL_CONTEXT_DESIGN.md)；
CTX-1..3 与 OUT-1..3 已完成。
