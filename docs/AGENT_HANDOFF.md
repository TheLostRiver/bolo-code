...
| **CLI TUI** | **~85–92%** | OI-14 retained 主体与 OI-15A–F display policy/单槽/只读 panel-pager/扩展目录 overlay/toast-error/compatibility cleanup 已完成；真人 Windows Terminal 仍未验 |
